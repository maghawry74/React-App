...
export default function Cart() {
  ...
  if (cart.length === 0) {
    output = (
      <div className="text-center min-h-screen flex justify-center items-center flex-col gap-2">
  ...
  return (
    <div className="w-3/4 mx-auto min-h-screen">
      <div className="flex justify-between items-center border-b-2 py-5 border-black">
        <div>
          <h1 className="lg:text-4xl sm:text-2xl">Shopping Cart</h1>
          <h1 className="lg:text-4xl sm:text-2xl ">Total: $ </h1>
        </div>
